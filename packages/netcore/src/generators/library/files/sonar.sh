...
org=codedesignplus
key=CodeDesignPlus.Net.Library.Key
csproj=tests/CodeDesignPlus.Net.Library.Test/CodeDesignPlus.Net.Library.Test.csproj
report=tests/CodeDesignPlus.Net.Library.Test/coverage.opencover.xml
